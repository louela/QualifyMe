...
namespace QualifyMe.Areas.Admin.Controllers
{
    public class Departments1Controller : Controller
    {
        ...
        // GET: Admin/Departments1
        public ActionResult Index()
        {
            return View(db.Departments.ToList());
        }

        // GET: Admin/Departments1/Details/5
        ...
        // GET: Admin/Departments1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Departments1/Create
        ...
        // POST: Admin/Departments1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Departments1/Delete/5
        ...
        // POST: Admin/Departments1/Delete/5
