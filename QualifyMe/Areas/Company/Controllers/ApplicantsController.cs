...
namespace QualifyMe.Areas.Company.Controllers
{
    public class ApplicantsController : Controller
    {
        // GET: Company/Applicants
            ...
            public ActionResult ListofApplicants(int id)
            {
            List<ApplicantView> applicant = this.asr.GetApplicantsByCompanyID(id).Take(10).ToList();
            ...
            public ActionResult ViewApplicant(int id)
            {
                ...
                ApplicantView qvm = this.asr.GetApplicantByApplicantID(id/*, uid*/);
                return View(qvm);
            }
